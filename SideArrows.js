function Arrow(position, orientation, id) {
  ...
  this.id = id;
  this.scale = 1
  this.origin = new Vector2(sprites.extras['arrow'].normal.width / 2, sprites.extras['arrow'].normal.height / 2)
  this.rect = new Rectangle(position.x - this.origin.x, position.y - this.origin.y, this.sprite.width, this.sprite.height);
...
Arrow.prototype.draw = function() {
  ...
  Canvas.drawImage(this.sprite, this.position, this.rotation, this.origin, this.scale)
}
