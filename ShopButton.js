function ShopButton(position) {
  ...
  this.rect = new Rectangle(position.x - this.origin.x / 2, position.y - this.origin.y / 2, this.sprite.width * 0.5, this.sprite.height * 0.5);
...
ShopButton.prototype.update = function() {
  this.origin = new Vector2(this.sprite.width / 2, this.sprite.height / 2)
  this.rect = new Rectangle(this.position.x - this.origin.x / 2, this.position.y - this.origin.y / 2, this.sprite.width * 0.5, this.sprite.height * 0.5);
